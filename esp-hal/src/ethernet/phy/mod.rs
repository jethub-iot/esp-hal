...
/// 2. **Alternative MDIO controllers** (e.g. SPI-attached MDIO frontends or
///    software bit-banged buses) feeding the same `Phy` driver code.
///
/// # Example
///
/// ```rust,no_run
...
///     fn read(&self, _phy: u8, _reg: u8) -> u16 { 0 }
